---
title: Roadmap
description: The development path and future goals for the OpenOutbox Relay.
---

import { Steps, Badge } from '@astrojs/starlight/components';

The OpenOutbox Relay is evolving from a robust core into a high-performance, universal distribution engine.
